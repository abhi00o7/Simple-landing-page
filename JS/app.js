...
const ArrayNames = { "About": ".about-us", "My Skills": ".skills", "Gallery Of Egypt": ".Gallery", "Time Line": ".time-line", "Contact Us": ".contact" };
...
dataObject = { "Landing Page Section": ".landing-page", "About Me": ".about-us", "Skills Section": ".skills", "Gallery Section": ".Gallery", "Time Line Section": ".time-line", "Contact Us Section": ".contact" };
...
function randomize() {
    if (backoption == true) {
        Interval = setInterval(function() {
            ...
            landingpage.style.backgroundImage = 'url("images/' + arrayimgs[randomN] + '")';
        }, 500);
